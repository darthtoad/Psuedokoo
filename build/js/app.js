...
$(document).ready(function () {
  ...
  $('#sudoku-form').submit(function (event) {
    event.preventDefault();
    $('#result').empty();
    var row1 = [$('#1a').val(), $('#1b').val(), $('#1c').val(), $('#1d').val(), $('#1e').val(), $('#1f').val(), $('#1h').val(), $('#1i').val()];

    var row2 = [$('#2a').val(), $('#2b').val(), $('#2c').val(), $('#2d').val(), $('#2e').val(), $('#2f').val(), $('#2h').val(), $('#2i').val()];

    var row3 = [$('#3a').val(), $('#3b').val(), $('#3c').val(), $('#3d').val(), $('#3e').val(), $('#3f').val(), $('#3h').val(), $('#3i').val()];

    var row4 = [$('#4a').val(), $('#4b').val(), $('#4c').val(), $('#4d').val(), $('#4e').val(), $('#4f').val(), $('#4h').val(), $('#4i').val()];

    var row5 = [$('#5a').val(), $('#5b').val(), $('#5c').val(), $('#5d').val(), $('#5e').val(), $('#5f').val(), $('#5h').val(), $('#5i').val()];

    var row6 = [$('#6a').val(), $('#6b').val(), $('#6c').val(), $('#6d').val(), $('#6e').val(), $('#6f').val(), $('#6h').val(), $('#6i').val()];

    var row7 = [$('#7a').val(), $('#7b').val(), $('#7c').val(), $('#7d').val(), $('#7e').val(), $('#7f').val(), $('#7h').val(), $('#7i').val()];

    var row8 = [$('#8a').val(), $('#8b').val(), $('#8c').val(), $('#8d').val(), $('#8e').val(), $('#8f').val(), $('#8h').val(), $('#8i').val()];

    var row9 = [$('#9a').val(), $('#9b').val(), $('#9c').val(), $('#9d').val(), $('#9e').val(), $('#9f').val(), $('#9h').val(), $('#9i').val()];

    var sudoku = new _scripts.Sudoku(row1, row2, row3, row4, row5, row6, row7, row8, row9);

    var value = sudoku.check();
