...
describe('Sudoku', function(){
  ...
  it('should return true if all squares, rows, and columns only have unique numbers', function(){
  ...
  it('should return false if all squares, rows, and columns have repeat numbers', function(){
